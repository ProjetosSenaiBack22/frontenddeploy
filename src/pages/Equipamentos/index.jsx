...
export const Equipamentos = () => {
    ...
    const Cadastrar = (event) => {
      ...
      axios({
        method: "post",
        url: "http://api-grupo1.azurewebsites.net/api/Equipamentos",
        data: formData,
    ...
    const Listar = () => {
      axios.get('http://api-grupo1.azurewebsites.net/api/Equipamentos')
      .then(resposta => {
    ...
    const Remover = (id) => {
      axios.delete('http://api-grupo1.azurewebsites.net/api/Equipamentos/'+id)
      .then(() => {
        Listar();
      })
      .catch(erro => console.log(erro))
          ...
          <main className="container">
            ...
            {produtos.map(item => 
              <div className="card" key={item.id}>
                <img src={"http://api-grupo1.azurewebsites.net/img/"+item.imagem} alt="" />
                <div>
